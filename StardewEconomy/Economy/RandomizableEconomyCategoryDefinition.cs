...
{
    /// <summary>
    /// Registry metadata for economy categories that can be randomized by a save profile.
    /// </summary>
    internal sealed class RandomizableEconomyCategoryDefinition
    {
        ...
        public RandomizableEconomyCategoryDefinition(
            string key,
