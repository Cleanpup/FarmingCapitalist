...
{
    public sealed class ForageableMarketSimulationActorState : ICategoryMarketActorState
    {
        ...
        public List<string> FocusForageableItemIds { get; set; } = new();

        IList<string> ICategoryMarketActorState.FocusItemIds
        {
            get => FocusForageableItemIds;
            set => FocusForageableItemIds = value is List<string> focusItemIds
                ? focusItemIds
