...
{
    public sealed class EquipmentMarketSimulationActorState : ICategoryMarketActorState
    {
        ...
        public List<string> FocusEquipmentItemIds { get; set; } = new();

        IList<string> ICategoryMarketActorState.FocusItemIds
        {
            get => FocusEquipmentItemIds;
            set => FocusEquipmentItemIds = value is List<string> focusItemIds
                ? focusItemIds
