...
{
    public sealed class ArtisanGoodMarketSimulationActorState : ICategoryMarketActorState
    {
        ...
        public List<string> FocusArtisanGoodItemIds { get; set; } = new();

        IList<string> ICategoryMarketActorState.FocusItemIds
        {
            get => FocusArtisanGoodItemIds;
            set => FocusArtisanGoodItemIds = value is List<string> focusItemIds
                ? focusItemIds
